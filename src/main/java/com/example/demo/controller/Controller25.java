...
public class Controller25 {
	...
	public void method1() {
		System.out.println("/sub25/link1에서 일할 메소드");
	}
	...
	public void method5(@PathVariable("id") String id, @PathVariable("age") int age) {
		System.out.println(id + ", " + age);
	}

	// /sub25/link6/id/3/name/pprk
	...
	public String method12(RedirectAttributes rttr) {
		rttr.addFlashAttribute("list", List.of("강호동", "유재석"));
	...
	@GetMapping("link16")
	public void method16(@RequestParam("email") String email, @RequestParam("location") String location) {
