...
<body>
	...
	<div>
		<button id="btn1">완료 후 실행(성공)</button>
	</div>
	<div>
		<button id="btn2">완료 후 실행(실패)</button>
	</div>
	<div>
	...
	<div>
		<button id="btn7">성공응답(200), done</button>
	</div>
	
	<div>
		<button id="btn8">실패응답(500), fail</button>
	</div>
	<div>
		<button id="btn9">본문있는 성공 응답</button>
	</div>
	<div>
		<button id="btn10">성공 응답, 현재 시간</button>
		<div id="res10"></div>
	</div>
	<div>
