...
<body>
	...
	<br />
	<button id="btn2">json 전송 연습</button>
	<br />
	...
	<br />
	<button id="btn6">Bean값 전송</button>
	<br />
	...
	<br />
	<input type="number" id="inputScore" placeholder="점수" />
	<br />

	결혼여부<input type="checkbox" id="inputMarried2" />
	<!-- <input type="checkbox" name="checkYes" id="checkYes" value="true" />
	<label for="checkYes">기혼</label> -->
	<!-- <input type="checkbox" name="checkNo" value="false" />
	<label for="checkNo">미혼</label> -->
	<br />
